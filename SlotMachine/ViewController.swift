...
//  SlotMachine
//
//  Created by Ben Humphreys on 16/06/2015.
...
class ViewController: UIViewController {
    ...
    func setupContainerViews() {
        ...
        self.fourthContainer = UIView(frame: CGRect(x: self.view.bounds.origin.x + kMarginForView, y: firstContainer.frame.height + secondContainer.frame.height + thirdContainer.frame.height, width: self.view.bounds.width - (kMarginForView * 2), height: self.view.bounds.height
             * kSixth))
    ...
    func setupSecondContainer(containerView: UIView) {
        ...
        for var containerNumber = 0; containerNumber <
            kNumberOfContainers; ++containerNumber {
